...
function add(number1, number2){
  let numb1 = Number(number1)
  let numb2 = Number(number2)
  return numb2 + numb1
}
let theAnswer = add(1,9)
...
// console.log('declaration')
 console.log('expression') //<------ its this one
...
const exclaimTwo = str => {
 ...
 console.log('arrow') //<----- its this one
// console.log('declaration')
...
// console.log('arrow')
 console.log('declaration') //<---- its this one 
// console.log('expression')
...
let nameGretting = nameCheck('Steven')
...
function faveColorFinder(color){
  if(color === 'red'){return `${color} is a great color`}
  else if(color === 'green'){return `${color} is a solid favorite color`}
...
function thatsOdd(odd){
  if(odd % 2 === 0){return 'That\'s not odd!'}
...
/* 
  ...
  If the number is LESS than or EQUAL to 100, push 'small' as a string to thea nswers array. 
...
function emailCheck(email){
  ...
  else return 'must provide a calid email address'
}
console.log(emailCheck('codymail'))
console.log(emailCheck('cody@mail'))
...
function frog(gold){
let chocolate = 3
let answer = gold / chocolate
return Math.floor(answer)
}
let totalFrogs = frog(23)
